        ...
        for key in list(row.keys()):
            if key in ["stats_json", "timing_json"]:
                ...
                if row.get('exit_code') == 0:
                    ...
                    row['lightweightness'] = row['hit_ratio'] / row['cpu_per_access'] if row['cpu_per_access'] > 0 else 0
...
if __name__ == "__main__":
    ...
    compare_based_on_size_ratio(data, property='cpu_per_access', compare_fn=min, draw=True)
